...
export default function Privacy() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-700">
      <main className="container py-12 md:py-20 max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white border border-blue-100 shadow-xl rounded-2xl p-8 md:p-12 space-y-8"
        >
          <section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Dati Raccolti e Finalità del Trattamento</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Comunicazione e Diffusione dei Dati</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Periodo di Conservazione</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Diritto di Reclamo</h2>
            <p className="leading-relaxed">
